...
parameters = {
    ...
    #'command' : '~/.conda/envs/py35/bin/python main_Ising.py',
    'arguments' : [['dt',dt],['T',2.8]],# fixed parameters -> this overwrites what is in para.dat
    #'loop' : [['n_step',np.arange(10,int(T/dt)+1,10)]] # looping parameters
    'loop' : [['n_step',10]] # looping parameters 
}
