...
def Ed_Ad_OP(h_protocol, min_h, max_h, var=True):
    """ Edward-Anderson order parameter

    Parameters
    --------
    h_protocol : matrix (n_sample, n_step)
        sampled protocols
    min_h : float
    ...
    var : bool
        If order parameter is computed from variance of standard deviation
    
    Return
    ----
    order parameters : float
