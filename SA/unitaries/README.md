...
```
This will run simulated annealing for 8 sites, from hx=-2. to h=2.0 state with 30 quenches and 20 time steps. The output file is out.txt and dt=0.05, with 100 restart. Verbose is set to false.
